defmodule DtCtx.UserTest do
  ...
  @sample_user %User{
    id: 1,
    encrypted_password: "$2b$12$YVI.NrsX3O2z5SwD4hOPt.J9yU8xlt3ns2dcMqSm3oYGVygMZQmb6",
  ...
  test "login changeset with valid attributes" do
    changeset =
      User.login_changeset(
        %User{encrypted_password: "$2b$12$YVI.NrsX3O2z5SwD4hOPt.J9yU8xlt3ns2dcMqSm3oYGVygMZQmb6"},
        %{username: "some content", name: "some content", password: "password"}
      )
  ...
  test "update changeset with no password change" do
    changeset =
      User.update_changeset(
        @sample_user,
        %{id: "1", username: "another_username", name: "some content", pin: "1234", role: "admin"}
      )
